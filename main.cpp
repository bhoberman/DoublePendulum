...
Eigen::Vector2d calculateAcceleration(Eigen::Vector2d position, Eigen::Vector2d velocity, Eigen::Vector2d mass, Eigen::Vector2d length) {
    ...
    acceleration(0) = -3*(length(0)*mass(1)*pow(velocity(0), 2.0)*cos(position(0))*cos(position(1))*sin(-position(0) + position(1)) + g*mass(1)*sin(position(0))*pow(sin(position(1)), 2.0) - 2*(length(1)*mass(1)*cos(position(1))*sin(position(0)) - length(1)*mass(1)*cos(position(0))*sin(position(1)))*pow(velocity(1), 2.0) - 2*(g*mass(0) + 2*g*mass(1))*sin(position(0)) + (length(0)*mass(1)*pow(velocity(0), 2.0)*sin(position(0))*sin(-position(0) + position(1)) + g*mass(1)*cos(position(0))*cos(position(1)))*sin(position(1)))/(3*length(0)*mass(1)*cos(position(0))*cos(-position(0) + position(1))*cos(position(1)) + 3*length(0)*mass(1)*cos(-position(0) + position(1))*sin(position(0))*sin(position(1)) - 12*length(0)*mass(1)*pow(cos(position(0)), 2.0) - 12*length(0)*mass(1)*pow(sin(position(0)), 2.0) - 4*length(0)*mass(0));
    acceleration(1) = (6*length(0)*mass(1)*pow(velocity(0), 2.0)*pow(cos(position(0)), 2.0)*sin(-position(0) + position(1)) + 6*length(0)*mass(1)*pow(velocity(0), 2.0)*pow(sin(position(0)), 2.0)*sin(-position(0) + position(1)) + 2*length(0)*mass(0)*pow(velocity(0), 2.0)*sin(-position(0) + position(1)) - 3*(length(1)*mass(1)*cos(-position(0) + position(1))*cos(position(1))*sin(position(0)) - length(1)*mass(1)*cos(position(0))*cos(-position(0) + position(1))*sin(position(1)))*pow(velocity(1), 2.0) - 3*(g*mass(0)*cos(-position(0) + position(1)) + 2*g*mass(1)*cos(-position(0) + position(1)))*sin(position(0)) + 2*(3*g*mass(1)*pow(cos(position(0)), 2.0) + 3*g*mass(1)*pow(sin(position(0)), 2) + g*mass(0))*sin(position(1)))/(3*length(1)*mass(1)*cos(position(0))*cos(-position(0) + position(1))*cos(position(1)) + 3*length(1)*mass(1)*cos(-position(0) + position(1))*sin(position(0))*sin(position(1)) - 12*length(1)*mass(1)*pow(cos(position(0)), 2.0) - 12*length(1)*mass(1)*pow(sin(position(0)), 2.0) - 4*length(1)*mass(0));
